...
$item_passwd = $row[passwd];
	...
	$sql = "update classboard set hit=$new_hit where num=$num";   // 글 조회수 증가시킴
					...
					<? include "../semantic/nav2.php"; ?>
					    ...
					    <div class="container">
					      ...
					      <ol class="breadcrumb">
					        ...
					        <li class="breadcrumb-item active">강의 게시판</li>
					      </ol>
...
<?
    ...
    $sql = "select * from reply where linkno=$num";
	$result = mysql_query($sql, $connect);
