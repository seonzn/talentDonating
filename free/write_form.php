  ...
  <body>
    ...
    <div class="container">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">강의 게시판 글쓰기</li>
      </ol>
		  ...
		  <tr>
		    ...
		    <td><input type="text" style="width:550px" class="form-control" style="" maxlength="50" name="title" ></td>
		  </tr>
		...
		<tr>
		  ...
		  <tr>
		    ...
		    <td><input type="text" style="width:50px" class="form-control" size="1" name="stnum"/>명 </td>
		  </tr>
		  <tr>
		    <td align="right">강의소개 </td>
		    <td><textarea name="content" class="form-control" rows="20" cols="60"></textarea></td>
		  </tr>
		  </table>
		  <br>
