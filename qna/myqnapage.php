  ...
  <head>
    ...
    <link rel="stylesheet" href="../css/font-awesome.min.css" media="screen" title="no title" charset="utf-8">
		<?
			...
			{
				$sql = "select * from qna where id='$userid' order by num desc";
			}
...
<body>
	...
	<div class="container">
		...
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active">나의 Q&A게시판</li>
		</ol>

		<img src="../images/about01.jpg" height="400px" width="1100px"><br><br>
		<!--게시판 시작 -->
		<div >
				<h5 align="left">▷ 총 <a class="text-danger"><?= $total_record ?></a> 개의 게시물이 있습니다.&nbsp;&nbsp;
					  	<input type="button" align="right" class="btn btn-primary" value="QnA 목록" onclick="location.href='list.php'"/></h5>
